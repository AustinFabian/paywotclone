(function () {
  ...
  window.trx_addons_get_embed_from_url = function (url, autoplay) {
    ...
    return (
      '<iframe src="' + url + '" border="0" width="1280" height="720"></iframe>'
    );
  };
      ...
      setTimeout(function () {
        if (
          ...
          if (obj.length > 0) {
            ...
            if (
              !isNaN(off) &&
              ((fixed_height > 0 && off - scroll < fixed_height + 60) ||
                scroll == 0)
            ) {
...
(function () {
  ...
  window.trx_addons_debug_log = function (s, clr) {
    if (TRX_ADDONS_STORAGE["user_logged_in"]) {
      if (jQuery("#debug_log").length == 0) {
        jQuery("body").append(
          '<div id="debug_log"><span id="debug_log_close" onclick="jQuery(\'#debug_log\').hide();">x</span><pre id="debug_log_content"></pre></div>'
        );
      }
  ...
  window.dao === undefined &&
    (window.dao = function (s, r, m) {
      if (TRX_ADDONS_STORAGE["user_logged_in"])
        alert(trx_addons_debug_object(s, r, m));
    });
...
(function () {
  ...
  jQuery(document).on("action.init_hidden_elements", function (e, container) {
    ...
    if (gmap.length > 0) {
      ...
      } else trx_addons_sc_googlemap_init(e, container);
    }
  });
